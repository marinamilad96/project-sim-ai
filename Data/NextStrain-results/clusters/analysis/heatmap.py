...
# Load your MSA
alignment = AlignIO.read(config['paths']['input_path']+ config['file_name']+ ".fasta", "fasta")
...
df_matrix.to_csv(config['paths']['output_path'] + config['file_name'] + "_distance_matrix.csv")
...
plt.title("Distance Matrix Heatmap" + " - " + config['file_name'])
plt.tight_layout()
plt.savefig(config['paths']['output_path'] + config['file_name'] + "_distance_matrix_plot.png")
#plt.show()
