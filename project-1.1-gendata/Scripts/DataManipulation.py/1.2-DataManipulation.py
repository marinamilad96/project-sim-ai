...
config_path = '/Users/MiladM-Dev/Documents/1PhD/project-1-N450/project-1.1-Data-desc/DataManipulation.py/config.yaml'
...
class ExtractSeqToExcel:
    ...
    def create_df_duplicated_ID_final(self, df: pd.DataFrame, df_name: str):
        ...
        output_file = f"{self.cfg['Extract_folder']['rep_IDs_file'].rsplit('.', 1)[0]}_{df_name}.csv"
    ...
    def apply_seq_to_excel(self):
        ...
        self.apply_filter()
        self.create_df_duplicated_ID_final(self.df_de_matched_rows, 'duplicated_de_matched_ID')
        self.create_df_duplicated_ID_final(self.df_xsl_de_filtered, 'duplicated_de_filtered_ID')
        return 'Filtered and other DataFrames created successfully'
